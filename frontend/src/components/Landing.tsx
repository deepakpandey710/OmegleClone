...
export const Landing = () => {
    ...
    //         <input className="border-4 border-black-500/100 ..." type="text" onChange={(e) => { setName(e.target.value) }} />
    //         <button className="bg-cyan-500 hover:bg-cyan-600 rounded  w-24" onClick={() => {
    //             setJoined(true)
    //         }}>Join</button>
    //     </div>
    // }
